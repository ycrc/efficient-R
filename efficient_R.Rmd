...
R documentation is terse and dense, but useful if you stick with it

Structured programming / functions are easier to isolate, benchmark and refactor
...
## Loop testing | Make sure they produce identical output
```{r}
n <- 10000
x <- 7
...
```
<div class="notes">
Up next - Simple parallel computing
</div>
...
## Resources
  - This presentation: [https://github.com/ycrc/efficient-R](https://github.com/ycrc/efficient-R)
  - R Book: [http://adv-r.had.co.nz](http://adv-r.had.co.nz)
  - R Manuals: [http://cran.r-project.org/manuals.html](http://cran.r-project.org/manuals.html)
  - R Inferno: [http://www.burns-stat.com/documents/books/the-r-inferno]([http://www.burns-stat.com/documents/books/the-r-inferno])